...
// Table 组件 Content层
var RowContainerList = function (_PureComponent) {
  _inherits(RowContainerList, _PureComponent);
  ...
  _createClass(RowContainerList, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          _props$headerComponen = _props.headerComponents,
          headerComponents = _props$headerComponen === undefined ? [] : _props$headerComponen,
          _props$columnComponen = _props.columnComponents,
          columnComponents = _props$columnComponen === undefined ? [] : _props$columnComponen,
          _props$rowComponents = _props.rowComponents,
          rowComponents = _props$rowComponents === undefined ? [] : _props$rowComponents;

      return _react2.default.createElement(
        'div',
        { className: 'row-container-list' },
        this.props.children,
        _react2.default.createElement(_rowContainer2.default, _extends({}, this.props, _defineProperty({
        ...
        list.map(function (row, index) {
          return _react2.default.createElement(_rowContainer2.default, _extends({}, _this2.props, {
            row: row,
